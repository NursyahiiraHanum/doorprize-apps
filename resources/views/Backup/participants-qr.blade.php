        ...
        @foreach($participants as $p)
            <div class="col-auto">
                <div class="ticket-card">
                    <!-- Header Kartu (Judul Event & Logo Voyages) -->
                    <div class="ticket-header">
                        ...
                        <!-- Logo Voyages (Jika file ada di public/images/logo-voyages.png) -->
                        <img src="{{ asset('public\assets\images/logo-chuhatsu.png') }}" 
                             alt="Voyages Logo" 
                             class="logo-voyages" 
                             onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-block';">
                        <span class="badge bg-light text-dark fw-bold" style="display:none; font-size: 10px;">CHUHATSU</span>
                    </div>
                    ...
                    <div class="ticket-body">
                        ...
                        <div class="qr-section">
                            <div class="qr-code">
                                {!! QrCode::size(115)->generate($p->qr_code ?? $p->npk) !!}
                            </div>
